                            ...
                            <form action="" method="POST">
                              <div class="col-md-4">
                                ...
                                <div class="form-group">
                                  <input type="hidden" name="id_kelas" class="form-control" value="<?php echo $r['id_kelas']; ?>" required readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="nip" class="form-control">
                                    ...
                                    <?php
                                    $query = mysqli_query($db, "SELECT * FROM tb_guru");
                                    while ($ed = mysqli_fetch_array($query)) {
                                      if ($r['wali_kelas'] == $ed['nip']) { ?>
                                        <option selected value="<?= $ed['nip'] ?>"><?= $ed['nama'] ?></option>
                                      <?php } else { ?>
                                        <option value="<?= $ed['nip'] ?>"><?= $ed['nama'] ?></option>
                                    <?php }
                                    } ?>
                                  </select>
                                </div>
                                <div class="form-group">
                                  ...
                                  <input type="text" id="nama_kelas" placeholder="nama kelas" name="nama_kelas" class="form-control" value="<?php echo $r['nama_kelas']; ?>" required oninvalid="this.setCustomValidity('nama kelas tidak boleh kosong')" oninput="setCustomValidity('')">
                                </div>
                                <div>
