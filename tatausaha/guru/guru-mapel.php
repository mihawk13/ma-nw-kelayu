                      ...
                      <div class="card-box">
                        ...
                        <div class="x_content">
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="box-body">
                                  ...
                                  while ($mpl = mysqli_fetch_array($qMapel)) {
                                    $qCheck = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM tb_mapel_guru WHERE nip = '$_GET[nip]' AND id_mapel = '$mpl[id]' AND id_kelas = '$kls[id_kelas]' AND thn_ajaran = '$_SESSION[tahunajaran]'"));
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="box-body mb-5">
                                  ...
                                  while ($mpx = mysqli_fetch_array($qExtra)) {
                                    $qCheck = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM tb_extra_guru WHERE nip = '$_GET[nip]' AND id_extra = '$mpx[id]' AND id_kelas = '$kls[id_kelas]' AND thn_ajaran = '$_SESSION[tahunajaran]'"));
                                    $checked = ($qCheck == NULL) ? '' : 'checked';
                                  ?>
                                    <div class="col-md-4"><label><input type="checkbox" <?= $checked ?> name="extra[]" value="<?= $kls['id_kelas'] . '-' . $mpx['id'] ?>"> <?= $mpx['nama_extra'] ?></label></div>
                                  <?php } ?>
                                </div>
                              </div>
                            <?php } ?>
                          ...
                          if (isset($_POST['simpan'])) {
                            ...
                            mysqli_query($db, "DELETE FROM tb_extra_guru WHERE nip = '$nip' AND thn_ajaran = '$thn'") or die($db->error);
                            ...
                            if (isset($_POST['extra'])) {
                              foreach ($_POST['extra'] as $val) {
                                ...
                                mysqli_query($db, "INSERT INTO tb_extra_guru VALUES('$nip', '$idext', '$idkls', '$thn')") or die($db->error);
                              }
                            }
